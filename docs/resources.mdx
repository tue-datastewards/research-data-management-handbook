...
<Tabs>
  <TabItem value="RDM" label="RDM support" default>
  ...
  <TabItem value="related" label="Ethics and privacy">
  ...
  <TabItem value="infra" label="Research infrastructure">
    - Platform for registering research projects, managing related processes, and requesting resources / [Research Cockpit](https://cockpit.research.tue.nl/servicedesk/customer/portals) 
    - Storage and other solutions catalog / [Storage Finder](https://storagefinder.tue.nl)
