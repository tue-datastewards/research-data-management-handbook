...
- Check the **preferred data formats of the** [repository](/docs/after-research/data-repository) of your choice. 4TU.ResearchData provides a [list of preferred file formats](https://data.4tu.nl/s/documents/Preferred_File_Formats_2023.pdf).
