...
## Step-by-step guide to create a data package for RAPS

To properly archive your research in TU/e internal archive RAPS, you should first prepare a data package following the guidelines below. For more information on RAPS and submitting your data package, access the [Research Cockpit](https://cockpit.research.tue.nl/servicedesk/customer/portal/7).

### Step 1: select and organize data that should be archived

### Step 2: convert files to the recommended formats

### Step 3: define the retention period

### Step 4: have your data package reviewed by RAPS data manager
